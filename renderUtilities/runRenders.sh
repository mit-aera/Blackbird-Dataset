...
# For Egg
./renderDatasetUsingROSToHEVC.py --datasetFolder /media/medusa/NAS/Datasets/IJRRBlackbirdDataset/v3/BlackbirdDatasetData/ --renderDir /home/medusa/render_temp/ --experimentList ["Ancient_Asia_Museum_Multiroom"] --render-prefix "ijrr_new_egg_sensors_1"
